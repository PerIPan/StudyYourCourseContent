...
export async function POST(request: NextRequest) {
  ...
  const userContent = context
    ...
    : `No course materials matched this question. Answer using general knowledge ONLY. You MUST clearly state at the start that this answer is based on general knowledge, not course materials. Do NOT cite any sources.\n${historyBlock}Student question: ${message}`;
